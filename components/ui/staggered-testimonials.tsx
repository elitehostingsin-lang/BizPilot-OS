...
export const StaggeredTestimonials = ({
    testimonials,
    className,
}: {
    ...
    const getRotation = (index: number) => {
        ...
        return (index % 2 === 0 ? 1 : -1) * ((index * 3) % 10);
    }

    return (
        <div className={cn("max-w-4xl mx-auto antialiased font-sans px-4 md:px-8 lg:px-12 py-20", className)}>
